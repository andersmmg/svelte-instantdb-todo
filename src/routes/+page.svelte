<script lang="ts">
  ...
  import { init_experimental, tx, id, type InstantQueryResult } from "@instantdb/core";
  ...
  const db = init_experimental({ appId: APP_ID, schema: graph });

  type Todo = InstantQueryResult<typeof db, { todos: {} }>;
...
<div class="container" class:dark-mode={darkMode}>
  ...
  {:else}
    <div class="form">
      <div role="button" tabindex="0" class="toggle-all" on:click={toggleAllTodos}>⌄</div>
    ...
    <div class="todo-list">
      {#each todos as todo}
        <div class="todo">
          ...
          <span role="button" tabindex="0" class="delete" on:click={() => deleteTodo(todo)}>𝘟</span>
        </div>
      {/each}
    </div>
    ...
    <div class="action-bar">
      ...
      <a role="button" tabindex="0" class="delete-completed" on:click={deleteCompleted}>Delete Completed</a>
    </div>
